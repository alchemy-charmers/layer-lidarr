...
# If layer options are used, add this to lidarr 
# and import layer in lib_lidarr
@pytest.fixture
def mock_layers(monkeypatch):
    ...
    monkeypatch.setattr('lib_lidarr.layer.options', options)
...
def mock_hookenv_config(monkeypatch):
    ...
    monkeypatch.setattr('lib_lidarr.hookenv.config', mock_config)


@pytest.fixture
def mock_remote_unit(monkeypatch):
    monkeypatch.setattr('lib_lidarr.hookenv.remote_unit', lambda: 'unit-mock/0')


@pytest.fixture
def mock_charm_dir(monkeypatch):
    monkeypatch.setattr('lib_lidarr.hookenv.charm_dir', lambda: '/mock/charm/dir')


@pytest.fixture
def lidarr(tmpdir, mock_hookenv_config, mock_charm_dir, monkeypatch):
    ...
    monkeypatch.setattr('lib_lidarr.LidarrHelper', lambda: helper)
